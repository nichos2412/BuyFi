...
class RegistrationViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        usernameField.frame = CGRect(x: 20, y: view.safeAreaInsets.top+15, width: view.width-40, height: 52)
        ...
        registerButton.frame = CGRect(x: 20, y: passwordField.bottom+15, width: view.width-40, height: 52)
